...
public class FortuneItem {
    ...
    private TypeOfFortune fortune;

    public TypeOfFortune getFortune(){
        return fortune;

    }

    public FortuneItem(Bitmap image, TypeOfFortune tyFor) {
        this.fortune = tyFor;
        this.image = image;
    ...
    public FortuneItem(Bitmap image, HingeType hinge, TypeOfFortune tyFor) {
        this.fortune = tyFor;
        this.hinge = hinge;
        this.image = image;
        type = DialItemType.Image;
    ...
    public FortuneItem(int color, int value, TypeOfFortune tyFor) {
        this.fortune = tyFor;
        this.color = color;
